...
folders = ['attributions_motif/all','attributions_motif/Motif1','attributions_motif/Motif2','attributions_motif/MotifNone',
           'attributions_motif/MotifBoth','attributions_motif/genomes_saved/all','attributions_motif/genomes_saved/Motif1',
           'attributions_motif/genomes_saved/Motif2','attributions_motif/genomes_saved/MotifNone','attributions_motif/genomes_saved/MotifBoth']
...
for i in range(len(attributions)):
    ...
    if labels_saved[i] == 0:
        ...
        label_motif = 'Motif2'
    elif labels_saved[i] == 2:
        label_motif = 'MotifBoth'
    elif labels_saved[i] == 3:
        label_motif = 'MotifNone'
    
    attr = NormalizeTensor(attributions[i][0].cpu())
    save_image(images_saved[i], "attributions_motif/genomes_saved/" + label_motif + "/" + str(i) + ".png")
    save_image(NormalizeTensor(attributions[i][0].cpu()), "attributions_motif/" + label_motif + "/" + str(i) + ".png")
    save_image(images_saved[i], "attributions_motif/genomes_saved/all/" + str(i) + ".png")
    save_image(NormalizeTensor(attributions[i][0].cpu()), "attributions_motif/all/" + str(i) + ".png")
    save_image(NormalizeTensor(attr_shift_sm[i][0].cpu()), "attributions_motif/all/" + str(i) + "shsm.png")
    
with open("attributions_motif/label_predictions.txt", "w") as output:
